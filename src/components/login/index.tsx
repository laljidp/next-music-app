  ...
  return (
    <div className="flex justify-center items-center w-full">
      <div
        ...
        text-sm flex border-solid border-emerald-500 ring-1
        p-5 rounded-xl max-w-lg"
      >
        <div className="flex flex-col justify-center gap-4">
          ...
          {userNotAdmin && (
            <div className="flex justify-center">
              <span
                className="font-medium text-white p-2 bg-violet-400 
            rounded-lg px-3 ring-2 ring-violet-400 shadow-md"
              >
